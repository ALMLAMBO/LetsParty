...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LetsParty.Backend.Models.User", b =>
                {
                    ...
                    b.Property<int>("PartyInviteOwnerId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("PartyInvitePartyId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("PartyInviteReceiverId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PartyInvitePartyId", "PartyInviteOwnerId", "PartyInviteReceiverId");
            ...
            modelBuilder.Entity("LetsParty.Backend.Models.User", b =>
                {
                    b.HasOne("LetsParty.Backend.Models.PartyInvite", "PartyInvite")
                        .WithMany()
                        .HasForeignKey("PartyInvitePartyId", "PartyInviteOwnerId", "PartyInviteReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
